...
3. **Clone Repository**: `git clone https://github.com/Prithviraj009/retail-store-devops-project.git.git`
...
```bash
git clone https://github.com/Prithviraj009/retail-store-devops-project.git.git
...
- **Issues**: [GitHub Issues](https://github.com/Prithviraj009/retail-store-devops-project.git/issues)
